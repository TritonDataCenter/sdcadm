 ...
 *          sdcadm_logs /var/log/sdcadm/sdcadm.log -b '/opt/smartdc/sdcadm/tools/rotate-logs.sh -i /var/log/sdcadm/logs/ /var/log/sdcadm/sdcadm.log' -t '/var/log/sdcadm/sdcadm_$nodename_%FT%H:%M:%S.log' -C 168 -S 1g -p 1h
...
function createLogger(opts) {
    ...
    // XXX Is trace level logging to the log file too much? That means a *lot*
    //     for updates.jo ListImages. Need to trim down those req/res's then.
