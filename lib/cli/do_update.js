    ...
    vasync.pipeline({funcs: [
        ...
        function execPlan(_, next) {
            ...
            var execUpdatePlanOpts = {
                ...
                justImages: opts.just_images,
                uuid: self.uuid,
                ufdsBackupTimeout: opts.ufds_backup_timeout
            };
            if (opts.experimental) {
...
do_update.options = [
    ...
    {
        names: ['ufds-backup-timeout'],
        type: 'integer',
        'default': 600,
        help: 'Timeout (in seconds) for the creation of the backup of all ' +
              'the UFDS data during ufds updates. Default: 600secs',
        helpArg: 'T'
    },
    {
        names: ['channel', 'C'],
